...
Al ejecutar la clase Main del paquete test, se abrirá un menú en la consola. La opción 1 (Encender fabrica) y la opción 5 (Apagar fabrica) imprimirán por pantalla el resultado de la implementación de los patrones de diseño realizados. Esta última opción, mostrará también una interfaz gráfica de usuario de despedida hecha con las librerías de Swing que, al ser cerrada, finalizará la ejecución del progrma.
